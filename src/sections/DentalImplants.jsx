    ...
    <main className="bg-gray-50 text-gray-800 pt-16">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <Fade direction="down">
            <h1 className="text-4xl md:text-5xl font-bold">Dental Implants</h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="left">
            ...
            <p className="text-lg text-center mb-6">
              Dental implants are the most advanced long-term solution for
              missing teeth. Each implant consists of three parts: the implant
              itself, which fuses with your jawbone; the connector, which holds
              the crown; and the crown itself, designed to look and function
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Fade direction="up">
            <ul className="list-disc list-inside space-y-3 text-lg">
              <li>
                Improved oral health—preventing bone loss and maintaining jaw
                structure.
              </li>
              <li>
                Natural appearance—implants seamlessly match your existing
                teeth.
              </li>
              <li>
                Comfortable and secure—no slipping or discomfort during daily
                activities.
              </li>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="left">
            ...
            <p className="text-lg text-center mb-6">
              Experience life-changing benefits at half the cost of traditional
              options. Our durable titanium implants snap securely into place
              without adhesives, giving you the confidence to eat, smile, and
              live freely.
            </p>
          </Fade>
          <Fade direction="up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                ...
                <p className="text-gray-700 mb-4">
                  Replace multiple missing teeth while preserving your jaw
                  structure.
                </p>
                <div className="w-full h-48 flex items-center justify-center rounded-md overflow-hidden">
                  <img
                    src="/Images/DI/di4.png"
                    alt="Implant Bridge"
                    className="w-full h-full object-cover"
                  />
                </div>
            ...
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                ...
                <p className="text-gray-700 mb-4">
                  Restore an entire upper or lower arch of teeth with fixed,
                  durable implants.
                </p>
                <div className="w-full h-48 flex items-center justify-center rounded-md overflow-hidden">
                  <img
                    src="/Images/DI/di5.png"
                    alt="Full Fixed Arch Implants"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
      ...
      <section className="bg-blue-700 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg mb-6">
            Schedule your appointment and take the first step towards a
            healthier smile.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            <button className="mb-3 h-12 items-center justify-center rounded-lg bg-blue-900 px-6 font-medium tracking-wide text-white shadow-md transition duration-200 md:mr-4 md:mb-0 md:w-auto focus:outline-none hover:bg-white hover:text-blue-900 border border-blue-900">
