            ...
            <div class="">
              ...
              <div class="mt-10 flex flex-col items-center md:flex-row">
                <Link
                  ...
                  duration={500}
                  offset={-100}
                  className="mb-3 inline-flex h-12 w-full items-center justify-center rounded border border-blue-700 bg-blue-700 px-6 font-medium tracking-wide text-white shadow-md transition duration-200 md:mr-4 md:mb-0 md:w-auto focus:outline-none hover:bg-white hover:text-blue-700"
                >
                  Book Appointment
                </Link>
              </div>
              <div class="mt-12 flex flex-col space-y-3 divide-gray-300 text-sm text-gray-700 sm:flex-row sm:space-y-0 sm:divide-x">
                ...
                <div class="flex max-w-xs space-x-2 px-4">
                  ...
                  <p> Leading dental clinic in daytona, Florida</p>
                </div>
              </div>
            </div>
