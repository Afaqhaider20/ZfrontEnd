        ...
        <div className="flex flex-col divide-y divide-gray-300 sm:mx-12 lg:px-12 xl:px-32 mb-10">
          <Fade>
            <details>
              <summary className="text-blue-950 py-2 outline-none cursor-pointer focus:font-semibold">
                {" "}
                What Services does ZFC Dentistry offer?
              </summary>

              <div className=" text-blue-800 px-4 pb-4">
                <p>
                  {" "}
                  zfc Dentistry offers a wide range of dental services, including
          ...
          <Fade>
            <details>
              <summary className="text-blue-950 py-2 outline-none cursor-pointer focus:font-semibold">
                {" "}
                What are the effects of taditional habit known as Tooth bud extraction?{" "}
              </summary>
              <div>
                <p className="px-4 pb-4 text-blue-800">
                ...
                <p className="px-4 pb-4 text-blue-700">
          ...
          <Fade>
            <details>
              <summary className="text-blue-950 py-2 outline-none cursor-pointer focus:font-semibold">
                {" "}
                How do I schedule an appointment at ZFC ?{" "}
              </summary>
              <div>
                <p className="text-blue-800 px-4 pb-4">
                  {" "}
                  To schedule appointment at ZFC simpy fill below form and
                  submit.
                </p>
                <p className="text-blue-800 px-4 pb-4">
                  {" "}
